...
class segmenter():
    ...
    def construct_network(self):
        ...
        model.compile(optimizer=Adam(learning_rate=0.00001), loss=self.loss_function, metrics=self.metrics)
        model.summary()
...
if __name__ == '__main__':
    ...
    unet = segmenter([1024, 512, 256, 128, 64], img_dim, loss_f=dice_coeff_loss,metrics=[dice_coeff])
